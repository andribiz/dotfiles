...
hs.hotkey.bind(hyper, 'p', function() hs.spotify.play() end)
...
hs.hotkey.bind(hyper, 't', function() am.switchToAndFromApp("org.alacritty") end)
hs.hotkey.bind(hyper, 'm', function() am.switchToAndFromApp("org.mozilla.firefox") end)
hs.hotkey.bind(hyper, 'f', function() am.switchToAndFromApp("com.apple.finder") end)
hs.hotkey.bind(hyper, 'c', function() am.switchToAndFromApp("com.google.chrome") end)
hs.hotkey.bind(hyper, 'a', function() am.switchToAndFromApp("com.apple.activitymonitor") end)
hs.hotkey.bind(hyper, 'v', function() am.switchToAndFromApp("com.microsoft.vscode") end)
hs.hotkey.bind(hyper, 'w', function() am.switchToAndFromApp("desktop.whatsapp") end)
hs.hotkey.bind(hyper, 's', function() am.switchToAndFromApp("org.whispersystems.signal-desktop") end)

-- window management
hs.hotkey.bind(hyper, 'k', function() wm.windowMaximize(0) end)
hs.hotkey.bind(hyper, 'l', function() wm.moveWindowToPosition(wm.screenPositions.right) end)
...
hs.hotkey.bind(hyper, 'h', function() wm.moveWindowToPosition(wm.screenPositions.left) end)
